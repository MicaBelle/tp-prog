...
public class Principal {
	...
	public static void main(String[] args) {
		...
		centro.ingresarVacunas("Pfizer", 30, new Fecha(30,3,2021));
		centro.ingresarVacunas("Pfizer", 10, new Fecha(20,4,2021));
		centro.ingresarVacunas("Pfizer", 20, new Fecha(10,6,2021));
		

		System.out.println("Vacunas totales: " + centro.vacunasDisponibles());
		System.out.println("Vacuna Pfizer: " + centro.vacunasDisponibles("Pfizer")); 
		System.out.println("Vacuna Moderna: " + centro.vacunasDisponibles("Moderna")); 
...
//		centro.vacunarInscripto(13000000, fTurnos);
		...
		System.out.println("------------- Centro --------------");
		System.out.println(centro);
		System.out.println("Reservadas: " + centro.vacunasDisponibles());
